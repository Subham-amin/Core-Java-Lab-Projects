...
public class App {
	...
	public static void main(String[] args) {
		...
		Student student1 = new Student("Subham", "Amin", "subhamamin95@gmail.com");
		Course course1 = new Course("MTECH");
		course1.setStudent(student1);
		student1.setCourse(course1);

		// creating student and course object and passing the values
		Student student2 = new Student("Sweta", "Das", "swetadas@gmail.com");
		Course course2 = new Course("B.Tech");
		course2.setStudent(student2);
		student2.setCourse(course2);

		// creating student and course object and passing the values
		Student student3 = new Student("Somenath", "Hazra", "hazrasomenath@gmail.com");
		Course course3 = new Course("B.Tech");
		course2.setStudent(student2);
		student2.setCourse(course2);
